// 하네스 스모크: server.mjs 부팅 + initialize + tools/list = 6 도구.
...
const EXPECTED_TOOLS = [
  "wormhole_status", "wormhole_dry_run", "wormhole_push",
  "wormhole_pull", "wormhole_resolve", "wormhole_sync",
];

test("smoke: 부팅 + initialize + tools/list = 6 도구", async (t) => {
  ...
  assert.deepEqual(names, [...EXPECTED_TOOLS].sort(), "정확히 6개 도구");
